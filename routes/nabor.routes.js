...
const { Klub, Kategorie, Sponzor, Tag, Prispevek, Sit, Universal} = require('../item');
...
router.get('/', async (req, res) => {
  try {
    ...
    res.render('public_views/universal', { kluby, kategorie, sponzori, tag, prispevky, site, universal, id_kategorie });
  } catch (error) {
    console.error(error);
